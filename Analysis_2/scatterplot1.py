...
# Convert 'team_1_runs' and 'team_2_runs' to numeric, coercing errors to NaN
...
plt.scatter(crick_df_filtered['team_1_runs'], crick_df_filtered['team_2_runs'], alpha=0.5)  # alpha for transparency

plt.xlabel("Team 1 Runs")
plt.ylabel("Team 2 Runs")
plt.title("Scatter Plot of Team 1 Runs vs Team 2 Runs")
